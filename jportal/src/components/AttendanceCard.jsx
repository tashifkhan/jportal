          ...
          <div className="py-4 flex flex-col items-center flex-1 overflow-y-auto scrollbar-hide">
            <div className="w-full max-w-[320px] flex flex-col">
              <Calendar
                ...
                className={`pb-2 text-white ${isLoading ? 'animate-pulse' : ''} w-full flex-shrink-0`}
                classNames={{
                  ...
                  head_row: "flex",
                  head_cell: "text-gray-500 rounded-md w-8 sm:w-9 font-normal text-[0.8rem]",
                  row: "flex w-full mt-2",
                  cell: "text-center text-sm sm:text-base p-0 relative [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
