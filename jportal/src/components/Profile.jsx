  ...
  return (
    <div className="min-h-screen bg-[var(--bg-color)] text-[var(--text-color)] font-sans px-2 pb-5 pt-8">
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[var(--card-bg)] rounded-2xl shadow-sm px-6 py-5">
        ...
        {/* Family Information */}
        <div className="bg-[var(--card-bg)] rounded-2xl shadow-sm px-6 py-5 overflow-auto">
          <h2 className="text-xl font-semibold mb-4 text-[var(--accent-color)]">
            Family Information
          </h2>
        ...
        <div className="bg-[var(--card-bg)] rounded-2xl shadow-sm px-6 py-5 col-span-1 lg:col-span-2">
          <h2 className="text-xl font-semibold mb-4 text-[var(--accent-color)]">
            Educational Qualifications
          </h2>
      ...
      {/* Footer remains full width below the grid */}
      <div className="w-full max-w-6xl mx-auto bg-[var(--card-bg)] rounded-2xl shadow-sm px-6 py-4 text-center mb-4 overflow-auto max-sm:text-sm text-lg mt-6">
